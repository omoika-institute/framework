...
class Markdown(BaseDisplay):
    """Markdown note display element.

    Entities with this element render as editable Markdown notes in the graph.

    Example:
        Markdown(label="Notes", value="# Findings")
    """
    element_type: str = 'md'
